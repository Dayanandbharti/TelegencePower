...
public class Attendance_Adapter extends RecyclerView.Adapter<Attendance_Adapter.CustomViewHolder > {
    ...
    public interface OnItemClickListener {
        void onItemClick(View view, int postion, Attendance_Get_Set item);
    }

    public OnItemClickListener listener;

    public Attendance_Adapter(Context context, ArrayList<Attendance_Get_Set> arrayList, OnItemClickListener listener) {
    ...
    class CustomViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(final int pos , final Attendance_Get_Set item, final OnItemClickListener listener) {
    ...
    public void onBindViewHolder(final CustomViewHolder holder, final int i) {
        ...
        final Attendance_Get_Set item=datalist.get(i);
...
//        holder.grdbatch.setAdapter(myAdapter);
        ...
        Courses_Attendance_Adapter_RecyclerView order_transactions_adapter_recyclerView = new Courses_Attendance_Adapter_RecyclerView(context,item.transactions);
