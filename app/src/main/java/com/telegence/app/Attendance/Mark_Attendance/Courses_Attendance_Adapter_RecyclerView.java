...
public class Courses_Attendance_Adapter_RecyclerView extends RecyclerView.Adapter<Courses_Attendance_Adapter_RecyclerView.CustomViewHolder> {

    List<Transactions_Get_Set> transactions_get_set;
    private LayoutInflater thisInflater;
    FragmentActivity activity;

    public Courses_Attendance_Adapter_RecyclerView(Context con, List<Transactions_Get_Set> transactions_get_set) {
    ...
    public CustomViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_course_student,viewGroup,false);
    ...
    public void onBindViewHolder(@NonNull CustomViewHolder holder, int position) {
        ...
        holder.attendance_switch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                holder.attendance = !holder.attendance;
                holder.attendance_switch.setActivated(holder.attendance);
            }
        });
        ...
        holder.txtproduct_price.setText(transactions.trans_id.replace(" ","\n"));
        ...
        if(transactions.trans_status.equalsIgnoreCase("0")){
            holder.txtdiamond_unit.setText("Inactive");
            ...
            holder.txtdiamond_unit.setText("Active");
            ...
            holder.txtdiamond_unit.setText("Completed");
...
//        }
    ...
    class CustomViewHolder extends RecyclerView.ViewHolder {
        ...
        View account_color_strip,attendance_switch;
        ...
        public CustomViewHolder(View convertView) {
            ...
            attendance_switch= (View) convertView.findViewById(R.id.attendance_switch);
        }
