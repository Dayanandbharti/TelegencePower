package com.telegence.app.Attendance.My_Courses;
...
public class MyCourse_Adapter extends RecyclerView.Adapter<MyCourse_Adapter.CustomViewHolder > {
    public Context context;



    ArrayList<My_Course_Get_Set> datalist;
    public interface OnItemClickListener {
        void onItemClick(View view, int postion, My_Course_Get_Set item);
    }

    public OnItemClickListener listener;

    public MyCourse_Adapter(Context context, ArrayList<My_Course_Get_Set> arrayList, OnItemClickListener listener) {
    ...
    public CustomViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewtype) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_mycourse,viewGroup,false);
    ...
    class CustomViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(final int pos , final My_Course_Get_Set item, final OnItemClickListener listener) {
    ...
    public void onBindViewHolder(final CustomViewHolder holder, final int i) {
        ...
        final My_Course_Get_Set item=datalist.get(i);
        ...
        holder.watch_btn.setText(item.created.replace(" ","\n"));
...
//        holder.grdbatch.setAdapter(myAdapter);
        ...
        My_Courses_Adapter_RecyclerView order_transactions_adapter_recyclerView = new My_Courses_Adapter_RecyclerView(context,item.transactions);
