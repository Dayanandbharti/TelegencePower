...
public class My_Courses_Adapter_RecyclerView extends RecyclerView.Adapter<My_Courses_Adapter_RecyclerView.CustomViewHolder> {

    List<Transactions_Get_Set> transactions_get_set;
    private LayoutInflater thisInflater;
    FragmentActivity activity;

    public My_Courses_Adapter_RecyclerView(Context con, List<Transactions_Get_Set> transactions_get_set) {
    ...
    public CustomViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_mycourse_student,viewGroup,false);
