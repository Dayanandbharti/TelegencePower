...
public class Forgot_Password extends Activity {
    ...
    Boolean is_signup = true;
    Context context;
    final Calendar myCalendar = Calendar.getInstance();
    SharedPreferences sharedPreferences;
    public Forgot_Password() {}
    View view_signup,view_otp,view_forgot,view_update_password;
    Fragment_Callback fragment_callback;

    public Forgot_Password(Fragment_Callback fragment_callback) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn_sendotp_mobile).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(txtforgotMobileNo!=null && txtforgotMobileNo.getText().toString().trim().equalsIgnoreCase("")){
                    Toaster.toast("Please Enter Mobile Number");
                } else if(txtforgotMobileNo.getText().length()<10){
                    Toaster.toast("Please Enter Valid Mobile Number");
                } else {
                    new MyForgotTask().execute();
                }
            }
        });
                    ...
                    else
                    {
                        if(vinputOTP.equals(vgeneratedOTP))
                        {
                            ...
                            if(is_signup){
                                ...
                                view_forgot.setVisibility(View.GONE);
                                view_update_password.setVisibility(View.VISIBLE);
        ...
        findViewById(R.id.txtlogin).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Forgot_Password.this, Login_A.class));
            }
        });
        ...
        view_forgot=findViewById(R.id.view_forgot);
        view_forgot.setVisibility(View.VISIBLE);
        ...
        view_update_password=findViewById(R.id.view_update_password);
    ...
    private class MyForgotTask extends AsyncTask<Void, Void, Void> {
        String result;
        ...
        protected Void doInBackground(Void... voids) {
            ...
            String val = ""+randomPIN;
            result=val;
            txtMobileNo.setText(txtforgotMobileNo.getText().toString());
            String recipient=txtMobileNo.getText().toString();
            String message = val;
            txt_sent_mob.setText("Enter the OTP sent to " + txtMobileNo.getText().toString());
            sendmsg(recipient,message);
    ...
    private void signin_updatepass_validation(){
        ...
        if(password.equalsIgnoreCase("")){
            ...
            Call_Api_For_Update_Pass(cp_ser_pass_edit.getText().toString());
        }
    }
    private void Call_Api_For_Update_Pass(String Password) {

        JSONObject parameters = new JSONObject();
        try {
            parameters.put("fb_id", txtforgotMobileNo.getText().toString());
            ...
            Glide.with(this)
                    ...
                    .into(new CustomTarget<Bitmap>() {
                        ...
                        public void onResourceReady(@NonNull Bitmap resource, @Nullable Transition<? super Bitmap> transition) {
                            String image_base64 = Functions.Bitmap_to_base64(Forgot_Password.this, resource);
    ...
    private void selectImage() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(Forgot_Password.this, R.style.AlertDialogCustom);
        ...
        builder.setItems(options, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int item) {
                ...
                if (options[item].equals("Take Photo")) {
                    if (Functions.check_permissions(Forgot_Password.this))
                        openCameraIntent();
    ...
    private void openCameraIntent() {
        ...
        if (pictureIntent.resolveActivity(Forgot_Password.this.getPackageManager()) != null) {
            ...
            if (photoFile != null) {
                Uri photoURI = FileProvider.getUriForFile(Forgot_Password.this.getApplicationContext(), Forgot_Password.this.getPackageName() + ".fileprovider", photoFile);
    ...
    private File createImageFile() throws IOException {
        ...
        File storageDir =
                Forgot_Password.this.getExternalFilesDir(Environment.DIRECTORY_PICTURES);
    ...
    public String getPath(Uri uri) {
        ...
        Cursor cursor = Forgot_Password.this.getContentResolver().query(uri, proj, null, null, null);
        if (cursor != null) {
    ...
    private void beginCrop(Uri source) {
        ...
        CropImage.activity(source).start(Forgot_Password.this);
    ...
    private void handleCrop(Uri userimageuri) {
        ...
        try {
            imageStream = Forgot_Password.this.getContentResolver().openInputStream(userimageuri);
        ...
        image_bas64 = Functions.Bitmap_to_base64(Forgot_Password.this, rotatedBitmap);
    ...
    public void Call_Api_For_image() {
        ...
        Functions.Show_loader(Forgot_Password.this, false, false);
        ApiRequest.Call_Api(Forgot_Password.this, Variables.uploadImage, parameters, new Callback() {
            @Override
            public void Responce(String resp) {
                Functions.cancel_loader();
                try {
                    ...
                    if (code.equals("200")) {
                        ...
                        if (Variables.user_pic != null && !Variables.user_pic.equals(""))
                            Picasso.get()
                                    ...
                                    .placeholder(Forgot_Password.this.getResources().getDrawable(R.drawable.profile_image_placeholder))
                                    .resize(200, 200).centerCrop().into(profile_image);

                        Toast.makeText(Forgot_Password.this, "Image Update Successfully", Toast.LENGTH_SHORT).show();
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                }
    ...
    public void is_valid_refer() {
        ...
        Functions.Show_loader(Forgot_Password.this, false, false);
        ApiRequest.Call_Api(Forgot_Password.this, Variables.is_valid_signup, parameters, new Callback() {
            @Override
            public void Responce(String resp) {
                Functions.cancel_loader();
                try {
    ...
    public void Call_Api_For_Edit_profile() {
        ...
        ApiRequest.Call_Api(Forgot_Password.this, Variables.updatepass, parameters, new Callback() {
            @Override
            public void Responce(String resp) {
                Functions.cancel_loader();
                try {
                    ...
                    if (code.equals("200")) {
                        ...
                        editor.commit();
                        startActivity(new Intent(Forgot_Password.this, MainMenuActivity.class));
                    } else {
                        if (msg != null) {
                            JSONObject jsonObject = msg.optJSONObject(0);
                            Toast.makeText(Forgot_Password.this, jsonObject.optString("response"), Toast.LENGTH_SHORT).show();
                        }
                    }
                } catch (Exception e) {
                    e.printStackTrace();
    ...
    public void Call_Api_For_delete_profile() {
        ...
        ApiRequest.Call_Api(Forgot_Password.this, Variables.delete_profile, parameters, new Callback() {
            @Override
            public void Responce(String resp) {
                Functions.cancel_loader();
                try {
                    ...
                    String msg = response.optString("msg");
                    if (code.equals("200")) {
                        Toast.makeText(Forgot_Password.this,"Profile Deleted Successfully", Toast.LENGTH_LONG).show();
    ...
    public void Call_Api_For_User_Details() {
        Functions.Show_loader(Forgot_Password.this, false, false);
        Functions.Call_Api_For_Get_User_data(Forgot_Password.this,
    ...
    public void Parse_user_data(String responce) {
        try {
            ...
            if (code.equals("200")) {
                ...
                Toast.makeText(Forgot_Password.this, "" + jsonObject.optString("msg"), Toast.LENGTH_SHORT).show();
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
