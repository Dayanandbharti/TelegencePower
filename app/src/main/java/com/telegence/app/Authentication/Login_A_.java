...
public class Login_A_ extends Activity {
        ...
        try {
            ...
            findViewById(R.id.txtsignup).setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(Login_A_.this, Sign_up.class);
            ...
            findViewById(R.id.txt__frgtpass).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    startActivity(new Intent(Login_A_.this, Forgot_Password.class));
                }
            });
        /*findViewById(R.id.btn_verify_password).setOnClickListener(new View.OnClickListener() {
            @Override
            ...
            public void Responce(String resp) {
                ...
                try {
                    ...
                    if(mypassword.equalsIgnoreCase("") || mypassword.equalsIgnoreCase("null"))
                        ...
                        if(vinputOTP.equals(""))
                        {
                            Toast.makeText(Login_A_.this, "Enter Password", Toast.LENGTH_LONG).show();
                        } else {
                            if(vinputOTP.equals(vgeneratedOTP))
                            {

                                Toast.makeText(Login_A_.this, "Welcome to Telegence", Toast.LENGTH_LONG).show();
                                Sign_in_with_Mobileno();
                            }
                            else
                            {
                                Toast.makeText(Login_A_.this, "Password  Not Verified !!", Toast.LENGTH_LONG).show();
                            }
                        }
                    }
                } catch (Exception e) {
    ...
    public void Loginwith_FB(){
        ...
        LoginManager.getInstance()
                .logInWithReadPermissions(Login_A_.this,
...
//        FacebookSdk.sdkInitialize(this.getApplicationContext());
        ...
        LoginManager.getInstance().registerCallback(mCallbackManager, new FacebookCallback<LoginResult>()  {
            ...
            public void onCancel() {
                // App code
                Toast.makeText(Login_A_.this, "Login Cancel", Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onError(FacebookException error) {
                Log.d("resp",""+error.toString());
                Toast.makeText(Login_A_.this, "Login Error"+error.toString(), Toast.LENGTH_SHORT).show();
            }
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            Functions.Show_loader(Login_A_.this,false,false);
                            ...
                            Functions.cancel_loader();
                            Toast.makeText(Login_A_.this, "Authentication failed.",
    ...
    public void Sign_in_with_gmail(){
        ...
        GoogleSignInAccount account = GoogleSignIn.getLastSignedInAccount(Login_A_.this);
            ...
            Glide.with(this)
                    ...
                    .into(new CustomTarget<Bitmap>() {
                        ...
                        public void onResourceReady(@NonNull Bitmap resource, @Nullable Transition<? super Bitmap> transition) {
                            String image_base64 = Functions.Bitmap_to_base64(Login_A_.this, resource);
