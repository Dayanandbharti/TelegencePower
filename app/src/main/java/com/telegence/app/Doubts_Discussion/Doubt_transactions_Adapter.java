...
public class Doubt_transactions_Adapter extends BaseAdapter {

    List<Transactions_Get_Set> transactions_get_set;
    private LayoutInflater thisInflater;
    FragmentActivity activity;

    public Doubt_transactions_Adapter(Context con, List<Transactions_Get_Set> transactions_get_set) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        if(convertView==null){
            convertView = thisInflater.inflate(R.layout.item_request_doubts, parent, false);
        }
