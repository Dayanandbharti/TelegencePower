...
public class Doubt_transactions_Adapter_RecyclerView extends RecyclerView.Adapter<Doubt_transactions_Adapter_RecyclerView.CustomViewHolder> {

    List<Transactions_Get_Set> transactions_get_set;
    private LayoutInflater thisInflater;
    FragmentActivity activity;

    public Doubt_transactions_Adapter_RecyclerView(Context con, List<Transactions_Get_Set> transactions_get_set) {
    ...
    @NonNull
    @Override
    public Doubt_transactions_Adapter_RecyclerView.CustomViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_request_doubts,viewGroup,false);
        view.setLayoutParams(new RecyclerView.LayoutParams(RecyclerView.LayoutParams.MATCH_PARENT, RecyclerView.LayoutParams.WRAP_CONTENT));
        Doubt_transactions_Adapter_RecyclerView.CustomViewHolder viewHolder = new Doubt_transactions_Adapter_RecyclerView.CustomViewHolder(view);
        return viewHolder;
    }
