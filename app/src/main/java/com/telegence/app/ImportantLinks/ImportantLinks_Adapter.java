...
public class ImportantLinks_Adapter extends RecyclerView.Adapter<ImportantLinks_Adapter.CustomViewHolder > implements Filterable {
    public Context context;
    ArrayList<ImportantLink_Get_Set> inbox_dataList = new ArrayList<>();
    ArrayList<ImportantLink_Get_Set> inbox_dataList_filter = new ArrayList<>();
    ...
    public interface OnItemClickListener {
        void onItemClick(ImportantLink_Get_Set item);
    }
    public interface OnLongItemClickListener{
        void onLongItemClick(ImportantLink_Get_Set item);
    }

    public ImportantLinks_Adapter(Context context, ArrayList<ImportantLink_Get_Set> user_dataList, OnItemClickListener listener, OnLongItemClickListener longlistener) {
    ...
    public CustomViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewtype) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_important_links,null);
    ...
    class CustomViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(final ImportantLink_Get_Set item, final OnItemClickListener listener, final  OnLongItemClickListener longItemClickListener) {
    ...
    public void onBindViewHolder(final CustomViewHolder holder, final int i) {
        ...
        final ImportantLink_Get_Set item=inbox_dataList_filter.get(i);
        ...
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (charString.isEmpty()) {
                    ...
                    ArrayList<ImportantLink_Get_Set> filteredList = new ArrayList<>();
                    for (ImportantLink_Get_Set row : inbox_dataList) {
            ...
            protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
                inbox_dataList_filter = (ArrayList<ImportantLink_Get_Set>) filterResults.values;
