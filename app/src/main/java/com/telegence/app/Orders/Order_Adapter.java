package com.telegence.app.Orders;
...
public class Order_Adapter extends RecyclerView.Adapter<Order_Adapter.CustomViewHolder > {
    public Context context;



    ArrayList<Order_Get_Set> datalist;
    public interface OnItemClickListener {
        void onItemClick(View view, int postion, Order_Get_Set item);
    }

    public OnItemClickListener listener;

    public Order_Adapter(Context context, ArrayList<Order_Get_Set> arrayList, OnItemClickListener listener) {
    ...
    class CustomViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(final int pos , final Order_Get_Set item, final OnItemClickListener listener) {
    ...
    public void onBindViewHolder(final CustomViewHolder holder, final int i) {
        ...
        final Order_Get_Set item=datalist.get(i);
        ...
        Double completed = Double.parseDouble(item.coompleted)/1000.0;
...
//        holder.grdbatch.setAdapter(myAdapter);
        ...
        Order_transactions_Adapter_RecyclerView order_transactions_adapter_recyclerView = new Order_transactions_Adapter_RecyclerView(context,item.transactions);
...
//        }
        if(item.mainstatus.equalsIgnoreCase("2")) {
        ...
        } else if(item.mainstatus.equalsIgnoreCase("0")){
            holder.view_main.setBackgroundTintList(ContextCompat.getColorStateList(context, R.color.redcolor_));
            holder.view_Details.setVisibility(View.VISIBLE);
        } else {
            holder.view_main.setBackgroundTintList(ContextCompat.getColorStateList(context, R.color.gray_lightest));
            holder.view_Details.setVisibility(View.VISIBLE);
        }
