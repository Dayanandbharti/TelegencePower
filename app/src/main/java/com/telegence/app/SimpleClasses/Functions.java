...
public class Functions {
    ...
    public static String getDownloadsFolder(Context activity) {
        return activity.getExternalFilesDir(Environment.DIRECTORY_DOWNLOADS).getAbsolutePath();
        //return Environment.getEx(Environment.DIRECTORY_DOWNLOADS).getAbsolutePath();
//        return Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).getAbsolutePath();
    ...
    public static void Call_Api_For_like_user(final Activity activity,
                                               String likedfb_id,String action,
                                               final API_CallBack api_callBack) {

        JSONObject parameters = new JSONObject();
        try {
            parameters.put("fb_id", Variables.sharedPreferences.getString(Variables.u_id,"0"));
            parameters.put("likedfb_id",likedfb_id);
            parameters.put("action",action);
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        ApiRequest.Call_Api(activity, Variables.likeDislikeUser, parameters, new Callback() {
            @Override
            public void Responce(String resp) {
                api_callBack.OnSuccess(resp);
            }
    ...
    public static void Call_Api_For_MyCoinBalance
            (final Activity activity,
             String FB_ID,
             final API_CallBack api_callBack) {
        ...
        ApiRequest.Call_Api(activity, Variables.getMyCoinBalance, parameters, new Callback() {
            @Override
            public void Responce(String resp) {
                Functions.cancel_loader();
                try {
    ...
    public static void Call_Api_For_my_inr_balance
            (final Activity activity,
             String FB_ID,
             final API_CallBack api_callBack) {
        ...
        ApiRequest.Call_Api(activity, Variables.getmy_inr_balance, parameters, new Callback() {
            @Override
            public void Responce(String resp) {
                Functions.cancel_loader();
                try {
    ...
    public static void Call_Api_For_WalletBalance
            (final Activity activity,
             String FB_ID,
             final API_CallBack api_callBack) {
        ...
        ApiRequest.Call_Api(activity, Variables.getwalletAmt, parameters, new Callback() {
            @Override
            public void Responce(String resp) {
                Functions.cancel_loader();
                try {
    ...
    public static void Call_Api_For_MyBalance
            (final Activity activity,
             String FB_ID,
             final API_CallBack api_callBack) {
        ...
        ApiRequest.Call_Api(activity, Variables.getMyBalance, parameters, new Callback() {
            @Override
            public void Responce(String resp) {
                Functions.cancel_loader();
                try {
    ...
    public static void Call_Api_For_All_Banner
            (final Activity activity,
             String diamond,
             final API_CallBack api_callBack) {
        ...
        JSONObject parameters = new JSONObject();
        try {
            parameters.put("banner",diamond);
        } catch (Exception e) {
            e.printStackTrace();
        }


        ApiRequest.Call_Api(activity, Variables.getallbanner, parameters, new Callback() {
            @Override
            public void Responce(String resp) {
                Functions.cancel_loader();
                try {
    ...
    public static void Call_Api_For_All_Products
            (final Activity activity,
             String diamond,
             final API_CallBack api_callBack) {
        ...
        ApiRequest.Call_Api(activity, Variables.getallproduct, parameters, new Callback() {
            @Override
            public void Responce(String resp) {
                Functions.cancel_loader();
                try {
    ...
    public static void Call_Api_For_All_Orders
            (final Activity activity,
             String status,String fb_id,String ordeR_id,
             final API_CallBack api_callBack) {
        ...
        try {
            parameters.put("status",status);
            parameters.put("fb_id",fb_id);
            parameters.put("order",ordeR_id);
        } catch (Exception e) {
            e.printStackTrace();
        }


        ApiRequest.Call_Api(activity, Variables.getallOrder, parameters, new Callback() {
            @Override
            public void Responce(String resp) {
                Functions.cancel_loader();
                try {
    ...
    public static void Call_Api_For_All_Transactions
            (final Activity activity,
             String status,String fb_id,
             final API_CallBack api_callBack) {
        ...
        ApiRequest.Call_Api(activity, Variables.getallTransaction, parameters, new Callback() {
            @Override
            public void Responce(String resp) {
                Functions.cancel_loader();
                try {
    ...
    public static void Call_Api_For_All_redeemreuestTransactions
            (final Activity activity,
             String status,String fb_id,
             final API_CallBack api_callBack) {
        ...
        ApiRequest.Call_Api(activity, Variables.getall_redeemtransaction, parameters, new Callback() {
            @Override
            public void Responce(String resp) {
                Functions.cancel_loader();
                try {
    ...
    public static void Call_Api_For_All_CoinTransactions
            (final Activity activity,
             String status,String fb_id,String type,
             final API_CallBack api_callBack) {

        JSONObject parameters = new JSONObject();
        try {
            parameters.put("status",status);
            parameters.put("typestatus",type);
            parameters.put("fb_id",fb_id);
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        ApiRequest.Call_Api(activity, Variables.getall_Cointransactions, parameters, new Callback() {
            @Override
            public void Responce(String resp) {
                Functions.cancel_loader();
                try {
    ...
    public static void Call_Api_For_My_Streams
            (final Activity activity,
             String fb_id,
             final API_CallBack api_callBack) {
        ...
        ApiRequest.Call_Api(activity, Variables.MyStreams, parameters, new Callback() {
            @Override
            public void Responce(String resp) {
                Functions.cancel_loader();
                try {
    ...
    public static void Call_Api_For_All_Batch
            (final Activity activity,
             String batches,
             final API_CallBack api_callBack) {
        ...
        ApiRequest.Call_Api(activity, Variables.getallbatch, parameters, new Callback() {
            @Override
            public void Responce(String resp) {
                Functions.cancel_loader();
                try {
    ...
    public static void Call_Api_For_All_Interest
            (final Activity activity,String fb_id,String batch_id,
             String allneed,final API_CallBack api_callBack) {

        JSONObject parameters = new JSONObject();
        try {
            parameters.put("fb_id",fb_id);
            parameters.put("interest_id",batch_id);
            parameters.put("all_need",String.valueOf(allneed));
        } catch (Exception e) {
            e.printStackTrace();
        }

        ApiRequest.Call_Api(activity, Variables.getallinterest, parameters, new Callback() {
            @Override
            public void Responce(String resp) {
                Functions.cancel_loader();
                try {
    ...
    public static void Call_Api_For_All_Country
            (final Activity activity,
             String batches,
             final API_CallBack api_callBack) {
        ...
        ApiRequest.Call_Api(activity, Variables.getallcountry, parameters, new Callback() {
            @Override
            public void Responce(String resp) {
                Functions.cancel_loader();
                try {
