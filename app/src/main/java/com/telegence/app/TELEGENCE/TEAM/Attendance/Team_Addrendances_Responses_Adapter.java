...
public class Team_Addrendances_Responses_Adapter extends RecyclerView.Adapter<Team_Addrendances_Responses_Adapter.CustomViewHolder > implements Filterable {
    public Context context;
    ArrayList<Team_Attendance_Get_Set> inbox_dataList = new ArrayList<>();
    ArrayList<Team_Attendance_Get_Set> inbox_dataList_filter = new ArrayList<>();
    ...
    public interface OnItemClickListener {
        void onItemClick(Team_Attendance_Get_Set item);
    }
    public interface OnLongItemClickListener{
        void onLongItemClick(Team_Attendance_Get_Set item);
    }

    public Team_Addrendances_Responses_Adapter(Context context, ArrayList<Team_Attendance_Get_Set> user_dataList, OnItemClickListener listener, OnLongItemClickListener longlistener) {
    ...
    class CustomViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(final Team_Attendance_Get_Set item, final OnItemClickListener listener, final  OnLongItemClickListener longItemClickListener) {
    ...
    public void onBindViewHolder(final CustomViewHolder holder, final int i) {
        ...
        final Team_Attendance_Get_Set item=inbox_dataList_filter.get(i);
        ...
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (charString.isEmpty()) {
                    ...
                    ArrayList<Team_Attendance_Get_Set> filteredList = new ArrayList<>();
                    for (Team_Attendance_Get_Set row : inbox_dataList) {
            ...
            protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
                inbox_dataList_filter = (ArrayList<Team_Attendance_Get_Set>) filterResults.values;
