...
public class Team_Attendance_Adapter extends RecyclerView.Adapter<Team_Attendance_Adapter.CustomViewHolder > implements Filterable {
    public Context context;
    ArrayList<Team_Atetndaces_Get_Set> inbox_dataList = new ArrayList<>();
    ArrayList<Team_Atetndaces_Get_Set> inbox_dataList_filter = new ArrayList<>();
    ...
    public interface OnItemClickListener {
        void onItemClick(Team_Atetndaces_Get_Set item);
    }
    public interface OnLongItemClickListener{
        void onLongItemClick(Team_Atetndaces_Get_Set item);
    }

    public Team_Attendance_Adapter(Context context, ArrayList<Team_Atetndaces_Get_Set> user_dataList, OnItemClickListener listener, OnLongItemClickListener longlistener) {
    ...
    public CustomViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewtype) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_attendance_list,null);
    ...
    class CustomViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(final Team_Atetndaces_Get_Set item, final OnItemClickListener listener, final  OnLongItemClickListener longItemClickListener) {
    ...
    public void onBindViewHolder(final CustomViewHolder holder, final int i) {
        ...
        final Team_Atetndaces_Get_Set item=inbox_dataList_filter.get(i);
        holder.username.setText(item.posted_name);
        holder.emp_id.setText(item.type);
        holder.poster_id.setText(item.posted_id);
        ...
        try{
            ...
            holder.last_message.setText(status);
            if (status.equalsIgnoreCase("IN")) {
                holder.last_message.setTypeface(null, Typeface.BOLD);
                holder.last_message.setTextColor(context.getResources().getColor(R.color.green));
            } else {
                holder.last_message.setTypeface(null, Typeface.NORMAL);
                holder.last_message.setTextColor(context.getResources().getColor(R.color.redcolor));
            }
        } catch (Exception e){
            holder.last_message.setTypeface(null, Typeface.NORMAL);
        ...
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (charString.isEmpty()) {
                    ...
                    ArrayList<Team_Atetndaces_Get_Set> filteredList = new ArrayList<>();
                    for (Team_Atetndaces_Get_Set row : inbox_dataList) {
            ...
            protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
                inbox_dataList_filter = (ArrayList<Team_Atetndaces_Get_Set>) filterResults.values;
