...
public class Doubts_Adapter extends RecyclerView.Adapter<Doubts_Adapter.CustomViewHolder > implements Filterable {
    public Context context;
    ArrayList<Doubts_Get_Set> inbox_dataList = new ArrayList<>();
    ArrayList<Doubts_Get_Set> inbox_dataList_filter = new ArrayList<>();
    ...
    public interface OnItemClickListener {
        void onItemClick(Doubts_Get_Set item);
    }
    public interface OnLongItemClickListener{
        void onLongItemClick(Doubts_Get_Set item);
    }

    public Doubts_Adapter(Context context, ArrayList<Doubts_Get_Set> user_dataList, OnItemClickListener listener, OnLongItemClickListener longlistener) {
    ...
    public CustomViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewtype) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_doub_list,null);
    ...
    class CustomViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(final Doubts_Get_Set item, final OnItemClickListener listener,final  OnLongItemClickListener longItemClickListener) {
    ...
    public void onBindViewHolder(final CustomViewHolder holder, final int i) {
        ...
        final Doubts_Get_Set item=inbox_dataList_filter.get(i);
        holder.username.setText(item.getName());
        holder.emp_id.setText("E.ID: #" + item.type);
        holder.poster_id.setText("E.ID: #" + item.posted_id);
        ...
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (charString.isEmpty()) {
                    ...
                    ArrayList<Doubts_Get_Set> filteredList = new ArrayList<>();
                    for (Doubts_Get_Set row : inbox_dataList) {
            ...
            protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
                inbox_dataList_filter = (ArrayList<Doubts_Get_Set>) filterResults.values;
