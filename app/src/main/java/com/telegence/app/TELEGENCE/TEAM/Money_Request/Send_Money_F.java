 ...
 */
public class Send_Money_F extends RootFragment implements View.OnClickListener{
    ...
    Spinner spn_employee,spn_manager;

    public static String exchange_action="Diamonds";
    public Send_Money_F() {}

    Fragment_Callback fragment_callback;
    public Send_Money_F(Fragment_Callback fragment_callback) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        context=getContext();
        MainMenuActivity.mainbar.setText("Send Money");
...
//        });
    ...
    public void Call_api_for_users() {
        ...
        ApiRequest.Call_Api(context, Variables.getallEmployee, jsonObject, new Callback() {
            @Override
            public void Responce(String resp) {
                parse_UsersData(resp);
            }
        });
    }
    public void parse_UsersData(String resp) {
        try {
            ...
            if (code.equals("200")) {
                ...
                if (msg.length() <= 0) {
                    ...
                    for (int i = 0; i < msg.length(); i++) {
                        ...
                        spinnerMap.put(i,data.getString("manager_id"));
    ...
    public void Call_api() {
        ...
        try {
            ...
            jsonObject.put("user_id", spinnerMap.get(spn_employee.getSelectedItemPosition()));
        ...
        ApiRequest.Call_Api(getContext(), Variables.send_money, jsonObject, new Callback() {
            @Override
            public void Responce(String resp) {
