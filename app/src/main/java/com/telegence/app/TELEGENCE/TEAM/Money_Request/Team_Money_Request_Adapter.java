...
public class Team_Money_Request_Adapter extends RecyclerView.Adapter<Team_Money_Request_Adapter.CustomViewHolder > implements Filterable {
    public Context context;
    ArrayList<Team_Money_Requests_Get_Set> inbox_dataList = new ArrayList<>();
    ArrayList<Team_Money_Requests_Get_Set> inbox_dataList_filter = new ArrayList<>();
    ...
    public interface OnItemClickListener {
        void onItemClick(Team_Money_Requests_Get_Set item);
    }
    public interface OnLongItemClickListener{
        void onLongItemClick(Team_Money_Requests_Get_Set item);
    }

    public Team_Money_Request_Adapter(Context context, ArrayList<Team_Money_Requests_Get_Set> user_dataList, OnItemClickListener listener, OnLongItemClickListener longlistener) {
    ...
    public CustomViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewtype) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_meney_request_list,null);
    ...
    class CustomViewHolder extends RecyclerView.ViewHolder {
        TextView emp_id,poster_id,poster_name,sr,username,last_message,date_created;
        ...
        public void bind(final Team_Money_Requests_Get_Set item, final OnItemClickListener listener, final  OnLongItemClickListener longItemClickListener) {
    ...
    public void onBindViewHolder(final CustomViewHolder holder, final int i) {
        ...
        final Team_Money_Requests_Get_Set item=inbox_dataList_filter.get(i);

        if(i%2!=0){
            holder.itemView.setBackgroundResource(R.color.background);
        }
        holder.sr.setText(String.valueOf(i+1));
        holder.username.setText(item.posted_name);
        holder.emp_id.setText("र" + item.type);
        ...
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (charString.isEmpty()) {
                    ...
                    ArrayList<Team_Money_Requests_Get_Set> filteredList = new ArrayList<>();
                    for (Team_Money_Requests_Get_Set row : inbox_dataList) {
            ...
            protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
                inbox_dataList_filter = (ArrayList<Team_Money_Requests_Get_Set>) filterResults.values;
